...
namespace MedicalResearch.SubjectData {
  ...
  public static class SdrCapabilities {
    ...
    public const string SubjectOverview = "SubjectOverview";
    public const string SubjectEnrollment = "SubjectEnrollment";
    public const string ParticipationStateMgmt = "ParticipationStateMgmt";
