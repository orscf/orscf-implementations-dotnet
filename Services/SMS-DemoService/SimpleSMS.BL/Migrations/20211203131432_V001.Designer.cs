...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicalResearch.StudyManagement.Persistence.InstituteEntity", b =>
                {
                    ...
                    b.Property<Guid>("OwnPatientSdrEndpointUid")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("InstituteUid");

                    b.HasIndex("OwnPatientSdrEndpointUid");
            ...
            modelBuilder.Entity("MedicalResearch.StudyManagement.Persistence.ResearchStudyEntity", b =>
                {
                    ...
                    b.Property<Guid>("PrimaryImsEndpointUid")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PrimaryImsEndpointUid");
            ...
            modelBuilder.Entity("MedicalResearch.StudyManagement.Persistence.InstituteEntity", b =>
                {
                    b.HasOne("MedicalResearch.StudyManagement.Persistence.SystemEndpointEntity", "OwnPatientSdr")
                        .WithMany()
                        .HasForeignKey("OwnPatientSdrEndpointUid")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("OwnPatientSdr");
                });
            ...
            modelBuilder.Entity("MedicalResearch.StudyManagement.Persistence.ResearchStudyEntity", b =>
                {
                    ...
                    b.HasOne("MedicalResearch.StudyManagement.Persistence.SystemEndpointEntity", "PrimaryIms")
                        .WithMany()
                        .HasForeignKey("PrimaryImsEndpointUid")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
