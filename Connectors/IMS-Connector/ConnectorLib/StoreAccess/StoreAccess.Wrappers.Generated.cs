...
namespace MedicalResearch.IdentityManagement.StoreAccess {
  ...
  public class GetSubjectParticipationBySubjectParticipationIdentityRequest {
    ...
    /// <summary> Required Argument for 'GetSubjectParticipationBySubjectParticipationIdentity' (SubjectParticipationIdentity): Composite Key, which represents the primary identity of a SubjectParticipation </summary>
    [Required]
    public SubjectParticipationIdentity subjectParticipationIdentity { get; set; }
  ...
  public class GetSubjectParticipationBySubjectParticipationIdentityResponse {
    ...
    /// <summary> Return-Value of 'GetSubjectParticipationBySubjectParticipationIdentity' (SubjectParticipation) </summary>
  ...
  public class UpdateSubjectParticipationBySubjectParticipationIdentityRequest {
    ...
    /// <summary> Required Argument for 'UpdateSubjectParticipationBySubjectParticipationIdentity' (SubjectParticipationIdentity): Composite Key, which represents the primary identity of a SubjectParticipation </summary>
    [Required]
    public SubjectParticipationIdentity subjectParticipationIdentity { get; set; }
    
    /// <summary> Required Argument for 'UpdateSubjectParticipationBySubjectParticipationIdentity' (SubjectParticipation): SubjectParticipation containing the new values (the primary identifier fields within the given SubjectParticipation will be ignored) </summary>
    [Required]
    public SubjectParticipation subjectParticipation { get; set; }
  ...
  public class UpdateSubjectParticipationBySubjectParticipationIdentityResponse {
    ...
    /// <summary> Return-Value of 'UpdateSubjectParticipationBySubjectParticipationIdentity' (Boolean) </summary>
    public bool @return { get; set; }
  ...
  public class DeleteSubjectParticipationBySubjectParticipationIdentityRequest {
    ...
    /// <summary> Required Argument for 'DeleteSubjectParticipationBySubjectParticipationIdentity' (SubjectParticipationIdentity): Composite Key, which represents the primary identity of a SubjectParticipation </summary>
    [Required]
    public SubjectParticipationIdentity subjectParticipationIdentity { get; set; }
  ...
  public class DeleteSubjectParticipationBySubjectParticipationIdentityResponse {
    ...
    /// <summary> Return-Value of 'DeleteSubjectParticipationBySubjectParticipationIdentity' (Boolean) </summary>
    public bool @return { get; set; }
  ...
  public class GetStudyScopeByResearchStudyUidRequest {
    ...
    /// <summary> Required Argument for 'GetStudyScopeByResearchStudyUid' (Guid): the official invariant name of the study as given by the sponsor </summary>
    [Required]
  ...
  public class GetStudyScopeByResearchStudyUidResponse {
    ...
    /// <summary> Return-Value of 'GetStudyScopeByResearchStudyUid' (StudyScope) </summary>
  ...
  public class UpdateStudyScopeByResearchStudyUidRequest {
    ...
    /// <summary> Required Argument for 'UpdateStudyScopeByResearchStudyUid' (Guid): the official invariant name of the study as given by the sponsor </summary>
    [Required]
    public Guid researchStudyUid { get; set; }
    
    /// <summary> Required Argument for 'UpdateStudyScopeByResearchStudyUid' (StudyScope): StudyScope containing the new values (the primary identifier fields within the given StudyScope will be ignored) </summary>
    [Required]
    public StudyScope studyScope { get; set; }
  ...
  public class UpdateStudyScopeByResearchStudyUidResponse {
    ...
    /// <summary> Return-Value of 'UpdateStudyScopeByResearchStudyUid' (Boolean) </summary>
    public bool @return { get; set; }
  ...
  public class DeleteStudyScopeByResearchStudyUidRequest {
    ...
    /// <summary> Required Argument for 'DeleteStudyScopeByResearchStudyUid' (Guid): the official invariant name of the study as given by the sponsor </summary>
    [Required]
    public Guid researchStudyUid { get; set; }
  ...
  public class DeleteStudyScopeByResearchStudyUidResponse {
    ...
    /// <summary> Return-Value of 'DeleteStudyScopeByResearchStudyUid' (Boolean) </summary>
    public bool @return { get; set; }
